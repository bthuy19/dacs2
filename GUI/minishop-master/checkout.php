...
?>
    ...
    <!-- END nav -->
	<script>
	var subtotalFromLocalStorage = localStorage.getItem('subtotal');
</script>
	          	...
	          	<div class="col-md-6 d-flex">
	          		<div class="cart-detail cart-total bg-light p-3 p-md-4">
	          			...
	          			<p class="d-flex">
									...
									<span><input id="subtotalInputt" style="border: none; background-color: #f8f9fa;" value="" disabled></span>
		    					</p>
		    					<p class="d-flex">
		    						<span>Delivery</span>
		    						<span>$0.00</span>
		    					...
		    					<p class="d-flex total-price">
		    						<span>Total</span>
		    						<span><input id="subtotalInputt2" style="border: none; background-color: #f8f9fa;" value="" disabled></span>
		    					</p>
								<script>
    var subtotal = localStorage.getItem('subtotal');
    console.log(subtotal); 
    document.getElementById('subtotalInputt').value = subtotal;
	document.getElementById('subtotalInputt2').value = subtotal;
</script>
								</div>
	          	</div>
	          	<div class="col-md-6">
