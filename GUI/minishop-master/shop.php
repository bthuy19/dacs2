...
?>
						...
						while ($row = mysqli_fetch_assoc($KQ)) {
							echo '<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
									<div class="product d-flex flex-column">
										<a href="product_single.php?IDSP=' . $row['id_pd'] . '" class="img-prod">
    ...
    function addToCart(productId, productName, price, quantity) {
        // Tại đây, bạn có thể sử dụng các thông tin về sản phẩm (productId, productName, price, quantity)
        // Gửi thông tin sản phẩm đi bằng AJAX hoặc thực hiện các hành động khác
        ...
        // Gửi yêu cầu AJAX để thêm vào giỏ hàng và xử lý thông tin sản phẩm ở đây
        // ...
    }
</script>
							<?php
